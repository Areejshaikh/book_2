...
from . import ask
from .v1.chat_endpoint import router as chat_endpoint_router
from .v1.simple_chat_endpoint import router as simple_chat_endpoint_router
...
api_router.include_router(simple_chat_endpoint_router, prefix="/chat", tags=["Chat"])  # Main chat endpoint at /api/v1/chat - matches frontend expectation
api_router.include_router(chat_endpoint_router, prefix="/detailed", tags=["Detailed Chat"])  # Detailed chat endpoint at /api/v1/detailed
